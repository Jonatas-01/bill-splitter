    ...
    return (
        <div>
            ...
            <div className="text-center mb-3 flex justify-center">
                <div className="loading-skeleton h-5 w-44 rounded-md" />
            </div>
            ...
            <div className="flex flex-col gap-3 mb-40">
                {rows.map((_, index) => (
                    ...
                    >
                        <div className="inner-loading-skeleton h-6 w-36 rounded-md" />
                        ...
                        <div className="flex items-center justify-evenly gap-2">
                            ...
                            <span className="inner-loading-skeleton h-8 w-20 rounded-full" />
                        </div>
                    </div>
                ))}
            ...
            <div className="bottom-menu md:max-w-xl w-full fixed bottom-0 left-0 right-0 mx-auto px-3 py-4">
